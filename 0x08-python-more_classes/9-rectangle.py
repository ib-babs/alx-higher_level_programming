...
class Rectangle:
    ...
    number_of_instances = 0  # class attribute - number_of_instances
    print_symbol = "#"  # class attribute - print_symbol
    ...
    def square(cls, size=0):
        ...
        cls_width = cls_height = size
        return cls(cls_width, cls_height)
